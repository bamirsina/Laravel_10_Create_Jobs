                    ...
                    <div class="relative mt-2 rounded-md shadow-sm">
                        ...
                        <form method="GET">
                            <label for="search"></label><input type="text" name="search" id="search" value="{{ request()->get('search') }}"
                                                               class="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6;" placeholder="Search For Employee">
                        ...
                        <tr class="bg-white border-b">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-2">
                                    <a href="{{ route('employee.show',['id' => $employee->id])}}" class="text-blue-700 hover:text-green-600">Show</a>
                                    <a href="{{ route('employee.edit', $employee) }}" class="text-green-400 hover:text-green-600">Edit</a>
                                    <form method="POST" class="text-red-400 hover:text-red-600" action="{{ route('employee.destroy', $employee) }}" onsubmit="return confirm('Are you sure you want to delete this employee?');">
                                        @csrf
                                        @method('DELETE')
